...
async function seed(): Promise<void> {
  ...
  // ─── Chores ───────────────────────────────────────────────────────────────
  const choreData = [
    { name: 'Make Bed', icon: 'mdi:bed', frequency: 'daily' as const },
    { name: 'Brush Teeth', icon: 'mdi:toothbrush', frequency: 'daily' as const },
    { name: 'Homework', icon: 'mdi:bookshelf', frequency: 'daily' as const },
    { name: 'Clean Room', icon: 'mdi:broom', frequency: 'daily' as const },
    { name: 'Set the Table', icon: 'mdi:silverware-fork-knife', frequency: 'daily' as const },
    { name: 'Feed the Dog', icon: 'mdi:dog', frequency: 'daily' as const },
    { name: 'Take Out Trash', icon: 'mdi:trash-can-outline', frequency: 'weekly' as const },
    { name: 'Vacuum', icon: 'mdi:vacuum', frequency: 'weekly' as const },
    { name: 'Dust Shelves', icon: 'mdi:feather', frequency: 'weekly' as const },
    { name: 'Mow the Lawn', icon: 'mdi:grass', frequency: 'weekly' as const },
    {
